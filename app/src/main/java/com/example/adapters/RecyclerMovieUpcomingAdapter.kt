...
class RecyclerMovieUpcomingAdapter(
    private val context: Context,
    private val listOfMovies: ArrayList<Movie>
) :
    RecyclerView.Adapter<RecyclerMovieUpcomingAdapter.MovieViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): RecyclerMovieUpcomingAdapter.MovieViewHolder {
        val view = LayoutInflater.from(context)
            .inflate(R.layout.other_movies_list_item, parent, false)
        return MovieViewHolder(view)
    }

    override fun onBindViewHolder(holder: RecyclerMovieUpcomingAdapter.MovieViewHolder, position: Int) {
