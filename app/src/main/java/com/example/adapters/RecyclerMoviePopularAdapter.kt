...
class RecyclerMoviePopularAdapter(
    private val context: Context,
    private val listOfMovies: ArrayList<Movie>
) :
    RecyclerView.Adapter<RecyclerMoviePopularAdapter.MovieViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): RecyclerMoviePopularAdapter.MovieViewHolder {
        val view = LayoutInflater.from(context)
            .inflate(R.layout.other_movies_list_item, parent, false)
        return MovieViewHolder(view)
    }

    override fun onBindViewHolder(holder: RecyclerMoviePopularAdapter.MovieViewHolder, position: Int) {
